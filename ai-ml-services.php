        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="feature-card delay-1 reveal">
                    ...
                    <h3 class="mt-8 text-2xl font-semibold text-slate-900"> Data Processing</h3>
                    <p class="mt-3 text-base text-slate-700 leading-relaxed">
                        Data is only valuable when it’s usable. We harness AI to clean, process, and visualize complex
                        datasets,
                        integrating seamlessly with tools like Power BI and custom dashboards to give you clarity that
                        drives action.
                    </p>
                </div>
