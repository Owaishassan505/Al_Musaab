    ...
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition group">
        ...
        <ul class="text-sm text-gray-700 space-y-1">
          ...
          <li><strong>Calgary:</strong> <a href="tel:4036911018" class="">403-691-1018</a>
          </li>
      ...
      <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition group">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-semibold">Calgary</h2>
        </div>
        <p class="text-gray-600 text-sm mb-2">
        ...
        <p class="text-sm text-gray-500 mb-4">Mon – Fri · 9:00 a.m. – 5:00 p.m. MDT</p>
        <p class="text-gray-700 font-medium">Phone:</p>
      ...
      <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition group">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-semibold">Edmonton</h2>
        </div>
        <p class="text-gray-600 text-sm mb-2">
      ...
      <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition group">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-semibold">Halifax</h2>
        </div>
        <p class="text-gray-600 text-sm mb-2">
          99 Wyse Rd, Suite #1100<br />
          Dartmouth, NS B3A 4S5
        </p>
        <p class="text-sm text-gray-500 mb-4">Mon – Fri · 9:00 a.m. – 5:00 p.m. AST</p>
        <p class="text-gray-700 font-medium">Phone:</p>
