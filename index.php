...
<body class="bg-white text-neutral-900 font-sans ">
        ...
        <ul class="glide__slides">
          ...
          <!-- <li class="glide__slide">
            <div
              ...
              <div>
                <img src="<?= $base . '/assets/images/brokerband-banner1.webp' ?>" alt="Brokerband Online Store"
                  class="w-full rounded-lg shadow-md" />
              </div>
            </div>
          </li> -->
  ...
  <section id="services" class="py-24 bg-gray-50 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
      <h2 class="text-4xl font-bold text-center mb-12 text-neutral-900">
        Our Core Services
      </h2>
      ...
      <div class="grid md:grid-cols-3 gap-10">
        ...
        foreach ($services as $i => $s): ?>
          <div
            ...
            <a href="<?= $base . '/' . $s["link"]; ?>" class="text-orange-600 text-sm font-semibold hover:underline">
              READ MORE
            </a>
          </div>
        <?php endforeach; ?>
  ...
  <!-- VIDEO SECTION -->
  <section id="video" class="py-24 bg-white overflow-x-hidden">
  ...
  <section id="support" class="py-24 bg-white relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
      <!-- Heading -->
      ...
      <div class="grid md:grid-cols-3 gap-10">
        <div class="bg-gray-50 rounded-xl p-8 shadow hover:shadow-lg transition">
          <i data-lucide="shield-check" class="w-10 h-10 text-orange-500 mb-4"></i>
          <h3 class="text-xl font-semibold text-neutral-900 mb-3">Stay Secure</h3>
          <p class="text-gray-600">
            From passwordless logins to 24/7 antivirus protection, we keep threats away so you can focus on your
            business.
          </p>
        </div>

        <div class="bg-gray-50 rounded-xl p-8 shadow hover:shadow-lg transition">
          <i data-lucide="database-backup" class="w-10 h-10 text-blue-600 mb-4"></i>
          <h3 class="text-xl font-semibold text-neutral-900 mb-3">Never Lose Data</h3>
          <p class="text-gray-600">
            Automated cloud backups mean your files are always safe and recoverable — no panic, no downtime.
          </p>
        </div>

        <div class="bg-gray-50 rounded-xl p-8 shadow hover:shadow-lg transition">
          <i data-lucide="headphones" class="w-10 h-10 text-green-600 mb-4"></i>
          <h3 class="text-xl font-semibold text-neutral-900 mb-3">Always Supported</h3>
          <p class="text-gray-600">
            Our live helpdesk and managed services team act as your in-house IT department, on call whenever you need
            us.
          </p>
        </div>
      </div>
      ...
      <div class="mt-12 flex justify-center">
        <a href="<?= $base . '/small-businesses' ?>" class="inline-flex items-center px-8 py-4 rounded-lg font-semibold shadow-lg
        text-white bg-orange-500 hover:bg-orange-600 transition">
          Read More (For Small Business Owners)
  ...
  <section class="py-24 bg-white relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <!-- Testimonial 1 -->
        <div
          class="bg-gradient-to-br from-gray-50 to-white rounded-xl p-8 shadow-md hover:shadow-xl transition duration-300 border border-gray-100">
      ...
      <div class="mt-16 grid md:grid-cols-4 gap-6 text-center">
        <div class="bg-orange-50 rounded-lg p-6 border border-orange-100">
          <p class="text-3xl font-bold text-orange-600">500+</p>
          <p class="text-sm text-gray-600 mt-2">Happy Clients Nationwide</p>
        </div>
        <div class="bg-orange-50 rounded-lg p-6 border border-orange-100">
          <p class="text-3xl font-bold text-orange-600">100%</p>
          <p class="text-sm text-gray-600 mt-2">Uptime Guarantee</p>
        </div>
        <div class="bg-orange-50 rounded-lg p-6 border border-orange-100">
          <p class="text-3xl font-bold text-orange-600">30+</p>
          <p class="text-sm text-gray-600 mt-2">Years of Excellence</p>
        </div>
        <div class="bg-orange-50 rounded-lg p-6 border border-orange-100">
          <p class="text-3xl font-bold text-orange-600">24/7</p>
          <p class="text-sm text-gray-600 mt-2">Expert Support</p>
        </div>
      </div>
    </div>
  </section>
