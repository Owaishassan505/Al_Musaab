...
<head>
    ...
    <title>Marketing & Growth | Al Musaab</title>
    ...
    <script type="application/ld+json">
      {
        ...
        "primaryImageOfPage": {
          "@type": "ImageObject",
          "url": "<?= $base . '/assets/images/Al-Musaab-logo1.png' ?>"
        },
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "Home",
            "item": "https://almusaab.com/"
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": "Contact Us",
            "item": "https://almusaab.com/contactus/"
          }
        ]
      }
    </script>
        ...
        <div class="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
            ...
            <div>
                ...
                <h1 data-aos="fade-right" data-aos-delay="150"
                    ...
                    Scale Faster.<br />
                    <span
                        class="bg-gradient-to-r whitespace-nowrap from-orange-600 via-orange-500 to-blue-600 bg-clip-text text-transparent font-bold">
                     Lead Your Industry.
                    </span>
                </h1>
                ...
                <p data-aos="fade-right" data-aos-delay="300"
                   ...
                   In a crowded landscape, "business as usual" marketing leads to invisible results. We help enterprises break through the noise by turning static strategies into precision-engineered campaigns that dominates markets.
                </p>
                ...
                <div data-aos="fade-up" data-aos-delay="450" class="mt-12 flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="<?= $base ?? '' ?>/website-development-seo-services"
    ...
    <section class="relative bg-white py-28 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <p data-aos="fade-up" data-aos-delay="200"
                ...
                We don’t just advise — we engineer outcomes. Al Musaab empowers
        ...
        <div class="max-w-7xl mx-auto px-6 relative">
            ...
            <div class="grid lg:grid-cols-2 gap-20 items-start">
                ...
                <div data-aos="fade-left" data-aos-delay="300"
                    ...
                    <img src="<?= $base ?>/assets/images/marketing_strategy_blueprint.jpg" alt="Strategic Blueprinting"
                ...
                <div class="order-3 lg:order-2" data-aos="fade-right" data-aos-delay="200">
                    <div class="p-8 rounded-2xl shadow-xl ring-1 ring-slate-100 bg-white">
                        <img src="<?= $base ?>/assets/images/Business_Architecture.png"
                ...
                <div class="order-5 lg:order-5" data-aos="fade-left" data-aos-delay="300">
                    <div class="p-8 rounded-2xl shadow-xl ring-1 ring-slate-100 bg-white">
                        <img src="<?= $base ?>/assets/images/marketing_integrated_execution.jpg"
                ...
                <div class="order-7 lg:order-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="p-8 rounded-2xl shadow-xl ring-1 ring-slate-100 bg-white">
                        <img src="<?= $base ?>/assets/images/marketing_continuous_optimization.jpg"
    ...
    <section id="solutions" class="relative bg-gray-100 font-sans">
        ...
        <div class="relative w-full">
            <div data-aos="fade-up"
                ...
                style="background-image: url('<?= $base ?>/assets/images/marketing_banner_consulting.jpg');">
            ...
            <div data-aos="fade-up"
                class="relative w-full aspect-[2/1] md:aspect-[3/1] lg:aspect-[4/1] bg-center bg-cover flex items-end p-8 md:p-16 text-white"
                style="background-image: url('<?= $base ?>/assets/images/marketing_banner_performance.jpg');">
            ...
            <div data-aos="fade-up"
                class="relative w-full aspect-[2/1] md:aspect-[3/1] lg:aspect-[4/1] bg-center bg-cover flex items-end p-8 md:p-16 text-white"
                style="background-image: url('<?= $base ?>/assets/images/marketing_campaign_architecture.jpg');">
