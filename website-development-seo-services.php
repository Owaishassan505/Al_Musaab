...
<head>
    ...
    <script type="application/ld+json">
  {
    "@context":"https://schema.org",
    "@type":"BreadcrumbList",
    "@id":"https://almusaab.com/contactus/#breadcrumb",
    "itemListElement":[
      {"@type":"ListItem","position":1,"name":"Home","item":"https://almusaab.com/"},
      {"@type":"ListItem","position":2,"name":"Contact Us","item":"https://almusaab.com/contactus/"}
    ]
  }
  </script>
...
<body class="bg-white text-neutral-900 font-sans">
    ...
    <section x-data="{ billing: 'monthly' }" class="relative bg-gradient-to-b from-blue-50 to-white pt-16 pb-20">
        <!-- Background pattern -->
        <div class="absolute inset-0 bg-[url('/assets/pattern.svg')] bg-cover opacity-5"></div>

        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <!-- Header -->
            <div class="text-center mb-10">
                <span
                    class="inline-block px-3 py-1 rounded-full text-sm font-semibold bg-orange-100 text-orange-600 shadow">
                    Get Full Access
                </span>
                <h2
                    class="mt-6 text-4xl font-bold bg-gradient-to-r from-orange-500 to-blue-600 bg-clip-text text-transparent">
                    Simple Pricing for Every Business
                </h2>
                <p class="mt-4 text-slate-600 text-lg max-w-2xl mx-auto">
                    Whether you’re just starting or already growing, pick a plan that fits your journey.
                </p>
            </div>

            <!-- Billing Toggle -->
            <div class="flex justify-center mb-12">
                <div class="inline-flex rounded-full border border-slate-200 bg-white p-1 shadow">
                    <button @click="billing = 'monthly'"
                        :class="billing === 'monthly' ? 'bg-orange-500 text-white' : 'text-slate-700'"
                        class="px-6 py-2 rounded-full font-medium transition-colors">
                        Monthly
                    </button>
                    <button @click="billing = 'yearly'"
                        :class="billing === 'yearly' ? 'bg-orange-500 text-white' : 'text-slate-700'"
                        class="px-6 py-2 rounded-full font-medium transition-colors">
                        Yearly <span class="ml-1 text-xs text-green-600 font-semibold">(Save more)</span>
                    </button>
                </div>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <!-- Standard -->
                <div class="flex flex-col rounded-2xl border border-slate-200 bg-white shadow-lg hover:shadow-xl p-8">
                    <h3 class="text-xl font-semibold text-slate-800">Standard</h3>
                    <p class="mt-2 text-slate-500">Perfect for small websites or personal projects.</p>

                    <!-- Price -->
                    <div class="mt-6">
                        <!-- Monthly -->
                        <div x-show="billing === 'monthly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$79</span>
                            <span class="text-4xl font-bold text-slate-900">$49</span>
                            <span class="ml-2 text-slate-500">/month</span>
                        </div>
                        <!-- Yearly -->
                        <div x-show="billing === 'yearly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$899</span>
                            <span class="text-4xl font-bold text-slate-900">$549</span>
                    ...
                    <a href="#contact"
                        class="mt-8 inline-flex justify-center px-6 py-3 rounded-lg font-semibold text-white bg-orange-500 hover:bg-orange-600 transition shadow-md">
                        Get Started
                    </a>
                </div>
                ...
                <!-- Premium -->
                <div
                    class="flex flex-col rounded-2xl border-2 border-orange-500 bg-white shadow-xl hover:shadow-2xl p-8 relative">
                    <span
                        class="absolute -top-3 right-6 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow">
                        Most Popular
                    </span>
                    <h3 class="text-xl font-semibold text-slate-800">Premium</h3>
                    <p class="mt-2 text-slate-500">For growing businesses needing extra features.</p>

                    <!-- Price -->
                    <div class="mt-6">
                        <!-- Monthly -->
                        <div x-show="billing === 'monthly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$149</span>
                            <span class="text-4xl font-bold text-slate-900">$99</span>
                            <span class="ml-2 text-slate-500">/month</span>
                        </div>
                        <!-- Yearly -->
                        <div x-show="billing === 'yearly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$1499</span>
                            <span class="text-4xl font-bold text-slate-900">$999</span>
                            <span class="ml-2 text-slate-500">/year</span>
                        </div>
                    </div>
                    ...
                    <ul class="mt-6 space-y-3 text-slate-600">
                        ...
                        <li>✔ Up to 15 pages designed</li>
                        <li>✔ Advanced design & branding</li>
                        <li>✔ Priority support (24/7)</li>
                        <li>✔ Monthly analytics reports</li>
                        <li>✔ Training & consultation hours</li>
                    </ul>
                    <a href="#contact"
                        class="mt-8 inline-flex justify-center px-6 py-3 rounded-lg font-semibold text-white bg-orange-500 hover:bg-orange-600 transition shadow-md">
                        Choose Premium
                ...
                <!-- Store -->
                <div class="flex flex-col rounded-2xl border border-slate-200 bg-white shadow-lg hover:shadow-xl p-8">
                    <h3 class="text-xl font-semibold text-slate-800">Store</h3>
                    <p class="mt-2 text-slate-500">For full online shops and advanced businesses.</p>

                    <!-- Price -->
                    <div class="mt-6">
                        <!-- Monthly -->
                        <div x-show="billing === 'monthly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$199</span>
                            <span class="text-4xl font-bold text-slate-900">$149</span>
                            <span class="ml-2 text-slate-500">/month</span>
                        </div>
                        <!-- Yearly -->
                        <div x-show="billing === 'yearly'" class="flex items-end">
                            <span class="line-through text-slate-400 mr-3">$2400</span>
                            <span class="text-4xl font-bold text-slate-900">$1599</span>
                            <span class="ml-2 text-slate-500">/year</span>
                        </div>
                    </div>
                    ...
                    <ul class="mt-6 space-y-3 text-slate-600">
                        ...
                        <li>✔ Marketing & SEO assistance</li>
    ...
    <section class="relative bg-gradient-to-b from-blue-50 to-white py-20">
        ...
        <!-- Honeycomb Pattern -->
        <svg class="absolute inset-0 w-full h-full animate-bgShift" viewBox="0 0 200 173.2" preserveAspectRatio="none">
            <defs>
