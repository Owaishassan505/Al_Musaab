        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="mt-8 space-y-5 text-[15px] leading-7 text-neutral-700">
                <p>
                    ...
                    CURRENT SERVICES AGREEMENT WITh Al Musaab(IF ANY),
                    THE TERMS AND CONDITIONS OF YOUR CURRENT SERVICES AGREEMENT WITh Al MusaabCONTROLS.
                    YOU MUST ACCEPT THIS AGREEMENT BEFORE YOU CAN PURCHASE OR USE Al Musaab SERVICES FROM THIS WEBSITE.
                </p>
                        ...
                        <div class="mt-3 text-[15px] leading-7 text-neutral-800 space-y-4">
                            <p>We agree to use commercially reasonable efforts to provide the services you purchase as
                                ...
                                The Web site URL for the customer services guide is <a
                                    href="http://support.almusaab.com"
                                    class="text-blue-600 underline">http://support.almusaab.com</a>. If the URL changes
